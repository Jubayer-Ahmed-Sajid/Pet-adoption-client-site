...
const AddPet = () => {
    ...
    const { id } = useParams()
    console.log(PetDetails.adopted, PetDetails)
    ...
    const formik = useFormik({
        ...
        initialValues: {
            ...
            age: PetDetails.age,
            pet_location: PetDetails.pet_location,
            image: '',
            short_description: PetDetails.short_description,
            long_description: PetDetails.long_description,
    ...
    return (
        <div className='w-screen'>
            <form onSubmit={formik.handleSubmit} className=' bg-gray-600 p-4 space-y-2 mx-auto '>
                ...
                <Select id='adopted'
                    name='adopted'
                    defaultValue={PetDetails.adopted ? 'True' : 'False'}
