    ...
    return (
        <div>
            ...
            <div className='grid lg:grid-cols-3 gap-4'>
                ...
                {
                    donations.map(donation => <Link to={`/donationCampaign/${donation._id}`} key={donation._id} className="relative flex flex-col text-gray-700 bg-white shadow-md  rounded-xl bg-clip-border">
                        ...
                        <div className="px-6 py-4 lg:ml-4">
                            ...
                            <div className="lg:flex font-sans gap-4 text-center items-center  antialiased justify-between text-sm  bg-clip-text">
