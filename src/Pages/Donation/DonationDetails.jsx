  ...
  return (
    <div>
      <div className="space-y-2 my-4 mx-6">
        <h2 className="text-xl  py-2 text-[#aea4af] rounded-2xl w-fit px-6 font-semibold bg-[#eaecf0]">
          {donationDetails.pet_name}
        </h2>
        ...
        <h2 className="flex text-xl items-center">
          ...
          {donationDetails.last_date}
        </h2>
        <div className="flex items-center justify-between text-xl font-semibold">
          <h2 className="xl ml-4">Details</h2>
          <h2 className="flex items-center gap-2">
            <MdFavorite className="text-3xl"></MdFavorite> Add to Favorite
          </h2>
        </div>
        <hr />
        <div className="lg:flex gap-4 my-4">
          <img
            ...
            className="lg:w-2/4 w-full h-[70vh]  object-cover"
            alt=""
          />
          <div>
            <h2 className="text-xl font-semibold">
              {donationDetails.short_description}
            </h2>
            <br />
      ...
      <div>
        <Button
          disabled={
            donationDetails.status !== "Continue" ||
            donationDetails.max_donation_amount <=
              donationDetails.donated_Amount
          }
          onClick={handleOpen}
          className="mb-8 text-center ml-4 hover:bg-[#4CAF8d] bg-[#4CAF41] text-white"
        >
          Donate Now
        </Button>
        <Dialog open={open} handler={handleOpen} className="mx-auto my-4 w-3/4">
